    ...
    <div className="max-w-5xl mx-auto p-6 sm:p-10 space-y-6 animate-in fade-in-50 duration-200">
      ...
      <header className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 border-b border-[var(--line)] pb-5">
        ...
        <button
          ...
          className="flex items-center gap-1.5 h-10 px-4 rounded-lg bg-[var(--accent)] text-white text-xs font-bold hover:opacity-90 disabled:opacity-50 transition-opacity shrink-0"
        >
          {scoring ? (
            <>
