      ...
      <header className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 border-b border-[var(--line)] pb-5">
        <div>
          ...
          <p className="text-xs sm:text-sm text-[var(--muted)] mt-1">
            Historical log of compiled PDFs, tailored resumes, and raw database
            backup archives.
          </p>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-1.5 h-10 px-4 rounded-lg bg-[var(--accent)] text-white text-xs font-bold hover:opacity-90 transition-opacity shrink-0"
        >
