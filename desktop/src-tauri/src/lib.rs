...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::hr_templates::get_all_hr_templates,
            commands::hr_templates::get_hr_template_by_id,
            commands::hr_templates::create_hr_template,
            commands::hr_templates::update_hr_template,
            commands::hr_templates::delete_hr_template,
            commands::outreach::get_all_outreach_leads,
            commands::outreach::get_outreach_lead_by_id,
            commands::outreach::save_outreach_lead,
            commands::outreach::update_outreach_lead_status,
            commands::outreach::delete_outreach_lead,
            commands::outreach::delete_outreach_leads_batch,
            commands::outreach::tailor_outreach_message,
            commands::error_logs::record_error_log,
            commands::error_logs::get_error_logs,
            commands::error_logs::get_error_log_stats,
            commands::error_logs::delete_error_log,
            commands::error_logs::delete_error_logs_batch,
